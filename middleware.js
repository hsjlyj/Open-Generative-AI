...
function addSecurityHeaders(response) {
    ...
    response.headers.set(
        ...
        "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; media-src 'self' data: blob: https:; connect-src 'self' https://muapi.ai https://*.muapi.ai https://open-generative-ai-media.ganwugeliuyanji.workers.dev; font-src 'self' data:;"
    );
    return response;
}
